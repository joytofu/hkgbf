...
$cc=$_POST["cc"];
if($cc){
$biaoti="投诉建议-".$_POST["yyrq"];
	
$content = "<strong>留言标题</strong>：".$biaoti."<br /><strong>联系人</strong>：".$_POST["fullname"]."<br /><strong>联络电话</strong>：".$_POST["mobile"]."<br /><strong>备注信息</strong>：<br />".$_POST["content"];
...
window.location.href='index.php?c=list&ms=yuangonguser&p=207';
</script>";
